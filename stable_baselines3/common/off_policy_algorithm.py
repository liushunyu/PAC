...
from stable_baselines3.common.buffers import ReplayBuffer, ReplayGnnBuffer
...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    def _setup_model(self) -> None:
        ...
        if isinstance(self.observation_space, Graph):
            self.replay_buffer = ReplayGnnBuffer(
                self.buffer_size,
    ...
    def _dump_logs(self) -> None:
        ...
        if len(self.ep_success_buffer) > 0:
            logger.record("rollout/success_rate", safe_mean(self.ep_success_buffer))
